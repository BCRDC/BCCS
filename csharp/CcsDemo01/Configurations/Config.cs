...
namespace CcsDemo.Configurations
{
    public class Config
    {
        public readonly static string _endpoint = "https://bccsprod-bak.chinaeast2.cloudapp.chinacloudapi.cn/services/sms/messages?api-version=2018-10-01";


        public readonly static string _txtEndpoint = "http://bluecloudccs.21vbluecloud.com/services/sms/txts?api-version=2018-10-01";
        //测试ccs账号名称
        public readonly static string _testCcsAccount = "cmpp01";
        //密钥名称
        public readonly static string _keyName = "full";
        //密钥
        public readonly static string _keyValue = "";
        //测试模板名称
        public readonly static string _testTemplateName = "temp01";
        //测试手机号
